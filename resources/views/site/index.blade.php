...
<!-- Card Container -->
  ...
  <div>
   ...
   <div class="carousel">
    <a class="carousel-item" target="__blank" href="https://terapeutadosonodosbebes.com.br/pag_ins_enc_terapeuta_org_redir?utm_medium=org&utm_source=org-redir&utm_content=leads&utm_campaign=SFTB4"><img src="{{url('/images/1.png')}}" width="600"></a>
    <a class="carousel-item" target="__blank" href="https://terapeutadosonodosbebes.com.br/pag_ins_enc_terapeuta_org_redir?utm_medium=org&utm_source=org-redir&utm_content=leads&utm_campaign=SFTB4"><img src="{{url('/images/2.png')}}"></a>
